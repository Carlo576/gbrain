...
description: >-
  ...
  page, post the summary to the operator's messaging surface, and archive the
  audio. Belt-and-suspenders: fires both from a tool the voice persona can call
  mid-call and from the automatic call-end handler in server.mjs.
triggers:
  - "after the call"
  - "call ended"
  - "summarize the call"
